...
class PrompterRegister extends StatelessWidget {
  @override
              ...
              Column(
                children: [
                  Column(
                    ...
                    children: [
                      Text ("Sign up as Prompter", style: TextStyle(
                        fontSize: 30,
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        makeInput(label: "Promoter ID"),
                        makeInput(label: "Promoter name"),
                        makeInput(label: "Promotion or organization name"),
